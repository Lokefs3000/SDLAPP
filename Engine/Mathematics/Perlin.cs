...
namespace LonelyHill.Math
{
    public class Perlin
    {
        ...
        public static void SetOctaves(int octaves)
        {
            ...
            var len = (int)System.Math.Pow(2, octaves);
        ...
        public static float Noise(float x, float y, float z, int octaves, ref float min, ref float max)
        {
            ...
            perlin = System.Math.Abs((float)System.Math.Pow(perlin, 2));
        ...
        {
            int X = (int)System.Math.Floor(x) % _halfLength;
            int Y = (int)System.Math.Floor(y) % _halfLength;
            int Z = (int)System.Math.Floor(z) % _halfLength;
